...
//            targetRS->at(i).BRoutcome =  ((inst.wasBranchPredictedAsTaken && inst.wasBranchActuallyTaken) ||
//                                            (!(inst.wasBranchPredictedAsTaken) && !(inst.wasBranchActuallyTaken))); //if predicted next pc is not actual next pc
